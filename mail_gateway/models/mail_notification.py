...
class MailNotification(models.Model):
    ...
    def _to_store_defaults(self, target):
        # Odoo 19: mail.notification serializes through _to_store_defaults.
        return super()._to_store_defaults(target) + [
            Store.Attr("gateway_type", lambda r: r.gateway_type),
            Store.Attr("channel_name", lambda r: r.gateway_channel_id.name),
        ]
